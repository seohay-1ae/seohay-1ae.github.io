window.onload = function () {
    ...
    function init() {
        // Load images
        images = loadImages([
            "https://github.com/NCristina/Bubble-shooter-game/blob/master/bubble-sprites3.png?raw=true",
        ]);
    ...
    function onMouseMove(e) {
        ...
        var mouseangle = radToDeg(
            Math.atan2(player.y + level.tileheight / 2 - pos.y, pos.x - (player.x + level.tilewidth / 2))
        );
